...
export const ITEM_DEFINITIONS = Object.freeze({
  ...
  card_table: { id: "card_table", type: "placeable", area: "wintergarden", label: "Pack Cards table", icon: "▦", asset: "./assets/pack-cards-joker.png", detail: "Quartett rules and rare twists are always ready here." },
  ...
  kennel_sign: { id: "kennel_sign", type: "placeable", area: "meadow", label: "Kennel sign", icon: "▰", detail: "A cozy couch motif for close contact and long cuddles." },
  play_mat: { id: "play_mat", type: "placeable", area: "home", label: "Signature play mat", icon: "▤", detail: "A soft rug beside the den in both of your signature colors." },
...
const ITEM_COPY_DE = Object.freeze({
  ...
  card_table: ["Pack-Cards-Tisch", "Quartett-Regeln und seltene Wendungen warten hier."],
  ...
  kennel_sign: ["Kennel-Schild", "Ein gemütliches Sofa-Motiv für Nähe und ausgiebiges Kuscheln."],
  play_mat: ["Signatur-Spielmatte", "Ein weicher Teppich neben der Höhle in deinen beiden Signaturfarben."],

...
export const QUEST_DEFINITIONS = Object.freeze({
  ...
  "board-memory": {
    ...
    instruction: "Finde alle Paare mit möglichst wenigen Zügen.",
  ...
  "onion-free-grill": {
    ...
    instruction: "Gutes Grillgut auf den Rost, Zwiebeln aussortieren – bevor die Zeit abläuft.",
  ...
  "city-tour": {
    ...
    instruction: "Besuche die Ziele in der angezeigten Reihenfolge.",
...
const QUEST_COPY_EN = Object.freeze({
  ...
  "board-memory": ["Capy memory", "A proper board game for two clever minds.", "Board-game time! I remember the snacks, you remember the paths — deal?", "Find all pairs in as few moves as possible."],
  ...
  "onion-free-grill": ["The onion-free barbecue", "Grill favorite snacks — without a single onion.", "Barbecue night! Please watch out: I find onions truly capy-awful.", "Grill the good food and skip the onions before time runs out."],
  "city-tour": ["Out and about with Capy", "Find your way through a little city together.", "Bag packed? I love going out — as long as we go together.", "Visit the destinations in the order shown."],
